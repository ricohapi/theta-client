...
void main() {
  ...
  test('buildCompositeIntervalCapture', () async {
    ...
    await platform.buildCompositeIntervalCapture(options, 1);
  });
  ...
  test('progress of capture', () async {
    ...
    TestDefaultBinaryMessengerBinding.instance.defaultBinaryMessenger
        .setMockMethodCallHandler(channel, (MethodCall methodCall) async {
      expect(platform.notifyList.containsKey(10031), true,
    ...
    expect(platform.notifyList.containsKey(10031), false,
  ...
  test('call onStopFailed', () async {
    ...
    TestDefaultBinaryMessengerBinding.instance.defaultBinaryMessenger
        .setMockMethodCallHandler(channel, (MethodCall methodCall) async {
      expect(platform.notifyList.containsKey(10032), true,
