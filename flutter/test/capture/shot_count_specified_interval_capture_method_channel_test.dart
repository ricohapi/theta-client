...
void main() {
  ...
  test('buildShotCountSpecifiedIntervalCapture', () async {
    ...
    await platform.buildShotCountSpecifiedIntervalCapture(options, 1);
  });
  ...
  test('startShotCountSpecifiedIntervalCapture', () async {
    ...
    expect(
        await platform.startShotCountSpecifiedIntervalCapture(null, null, null),
        fileUrls);
  });
  ...
  test('call onCapturing', () async {
    ...
    TestDefaultBinaryMessengerBinding.instance.defaultBinaryMessenger
        .setMockMethodCallHandler(channel, (MethodCall methodCall) async {
      expect(platform.notifyList.containsKey(10023), true,
