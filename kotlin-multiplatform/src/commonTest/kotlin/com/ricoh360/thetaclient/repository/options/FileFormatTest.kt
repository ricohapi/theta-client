...
class FileFormatTest {
    ...
    fun convertOptionFileFormatTest() = runTest {
        val values = listOf(
            ...
            Pair(ThetaRepository.FileFormatEnum.VIDEO_2K_15F, MediaFileFormat(MediaType.MP4, 1920, 960, "H.264/MPEG-4 AVC", 15)),
            ...
            Pair(ThetaRepository.FileFormatEnum.VIDEO_4K_2F, MediaFileFormat(MediaType.MP4, 3840, 1920, "H.264/MPEG-4 AVC", 2)),
            Pair(ThetaRepository.FileFormatEnum.VIDEO_4K_5F, MediaFileFormat(MediaType.MP4, 3840, 1920, "H.264/MPEG-4 AVC", 5)),
            ...
            Pair(ThetaRepository.FileFormatEnum.VIDEO_2K_30F_H265_HEVC, MediaFileFormat(MediaType.MP4, 1920, 960, "H.265/HEVC", 30)),
            Pair(ThetaRepository.FileFormatEnum.VIDEO_4K_2F_H265_HEVC, MediaFileFormat(MediaType.MP4, 3840, 1920, "H.265/HEVC", 2)),
            Pair(ThetaRepository.FileFormatEnum.VIDEO_4K_5F_H265_HEVC, MediaFileFormat(MediaType.MP4, 3840, 1920, "H.265/HEVC", 5)),
            Pair(ThetaRepository.FileFormatEnum.VIDEO_4K_10F_H265_HEVC, MediaFileFormat(MediaType.MP4, 3840, 1920, "H.265/HEVC", 10)),
            Pair(ThetaRepository.FileFormatEnum.VIDEO_4K_30F_H265_HEVC, MediaFileFormat(MediaType.MP4, 3840, 1920, "H.265/HEVC", 30)),
            Pair(ThetaRepository.FileFormatEnum.VIDEO_5_7K_2F_H265_HEVC, MediaFileFormat(MediaType.MP4, 5760, 2880, "H.265/HEVC", 2)),
            Pair(ThetaRepository.FileFormatEnum.VIDEO_5_7K_5F_H265_HEVC, MediaFileFormat(MediaType.MP4, 5760, 2880, "H.265/HEVC", 5)),
            Pair(ThetaRepository.FileFormatEnum.VIDEO_5_7K_10F_H265_HEVC, MediaFileFormat(MediaType.MP4, 5760, 2880, "H.265/HEVC", 10)),
            Pair(ThetaRepository.FileFormatEnum.VIDEO_7K_2F_H265_HEVC, MediaFileFormat(MediaType.MP4, 7680, 3840, "H.265/HEVC", 2)),
            Pair(ThetaRepository.FileFormatEnum.VIDEO_7K_5F_H265_HEVC, MediaFileFormat(MediaType.MP4, 7680, 3840, "H.265/HEVC", 5)),
            Pair(ThetaRepository.FileFormatEnum.VIDEO_7K_10F_H265_HEVC, MediaFileFormat(MediaType.MP4, 7680, 3840, "H.265/HEVC", 10)),
        ...
        assertEquals(ThetaRepository.FileFormatEnum.entries.size, values.size)
