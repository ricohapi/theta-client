...
interface ShotCountSpecifiedIntervalCaptureScreenProps {
    navigation: {
        setOptions: (options: { title: string }) => void;
    };
}

const ShotCountSpecifiedIntervalCaptureScreen: React.FC<ShotCountSpecifiedIntervalCaptureScreenProps> = ({ navigation }) => {
