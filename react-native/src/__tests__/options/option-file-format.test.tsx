...
describe('VideoFileFormatEnum', () => {
  const data: string[][] = [
    ...
    [VideoFileFormatEnum.VIDEO_2K_30F_H265_HEVC, 'VIDEO_2K_30F_H265_HEVC'],
    [VideoFileFormatEnum.VIDEO_4K_2F_H265_HEVC, 'VIDEO_4K_2F_H265_HEVC'],
    [VideoFileFormatEnum.VIDEO_4K_5F_H265_HEVC, 'VIDEO_4K_5F_H265_HEVC'],
    [VideoFileFormatEnum.VIDEO_4K_10F_H265_HEVC, 'VIDEO_4K_10F_H265_HEVC'],
    [VideoFileFormatEnum.VIDEO_4K_30F_H265_HEVC, 'VIDEO_4K_30F_H265_HEVC'],
    [VideoFileFormatEnum.VIDEO_5_7K_2F_H265_HEVC, 'VIDEO_5_7K_2F_H265_HEVC'],
    [VideoFileFormatEnum.VIDEO_5_7K_5F_H265_HEVC, 'VIDEO_5_7K_5F_H265_HEVC'],
    [VideoFileFormatEnum.VIDEO_5_7K_10F_H265_HEVC, 'VIDEO_5_7K_10F_H265_HEVC'],
    [VideoFileFormatEnum.VIDEO_7K_2F_H265_HEVC, 'VIDEO_7K_2F_H265_HEVC'],
    [VideoFileFormatEnum.VIDEO_7K_5F_H265_HEVC, 'VIDEO_7K_5F_H265_HEVC'],
    [VideoFileFormatEnum.VIDEO_7K_10F_H265_HEVC, 'VIDEO_7K_10F_H265_HEVC'],
  ];
...
describe('FileFormatEnum', () => {
  const data: string[][] = [
    ...
    [FileFormatEnum.VIDEO_2K_15F, 'VIDEO_2K_15F'],
    ...
    [FileFormatEnum.VIDEO_4K_2F, 'VIDEO_4K_2F'],
    [FileFormatEnum.VIDEO_4K_5F, 'VIDEO_4K_5F'],
    ...
    [FileFormatEnum.VIDEO_2K_30F_H265_HEVC, 'VIDEO_2K_30F_H265_HEVC'],
    [FileFormatEnum.VIDEO_4K_2F_H265_HEVC, 'VIDEO_4K_2F_H265_HEVC'],
    [FileFormatEnum.VIDEO_4K_5F_H265_HEVC, 'VIDEO_4K_5F_H265_HEVC'],
    [FileFormatEnum.VIDEO_4K_10F_H265_HEVC, 'VIDEO_4K_10F_H265_HEVC'],
    [FileFormatEnum.VIDEO_4K_30F_H265_HEVC, 'VIDEO_4K_30F_H265_HEVC'],
    [FileFormatEnum.VIDEO_5_7K_2F_H265_HEVC, 'VIDEO_5_7K_2F_H265_HEVC'],
    [FileFormatEnum.VIDEO_5_7K_5F_H265_HEVC, 'VIDEO_5_7K_5F_H265_HEVC'],
    [FileFormatEnum.VIDEO_5_7K_10F_H265_HEVC, 'VIDEO_5_7K_10F_H265_HEVC'],
    [FileFormatEnum.VIDEO_7K_2F_H265_HEVC, 'VIDEO_7K_2F_H265_HEVC'],
    [FileFormatEnum.VIDEO_7K_5F_H265_HEVC, 'VIDEO_7K_5F_H265_HEVC'],
    [FileFormatEnum.VIDEO_7K_10F_H265_HEVC, 'VIDEO_7K_10F_H265_HEVC'],
  ];
