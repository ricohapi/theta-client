...
static convert_t ExposureCompensationEnum = {
  .toTheta = @{
    @"M_2_0": THETACThetaRepositoryExposureCompensationEnum.m20,
    @"M_1_7": THETACThetaRepositoryExposureCompensationEnum.m17,
    @"M_1_3": THETACThetaRepositoryExposureCompensationEnum.m13,
    @"M_1_0": THETACThetaRepositoryExposureCompensationEnum.m10,
    @"M_0_7": THETACThetaRepositoryExposureCompensationEnum.m07,
    @"M_0_3": THETACThetaRepositoryExposureCompensationEnum.m03,
    @"ZERO": THETACThetaRepositoryExposureCompensationEnum.zero,
    @"P_0_3": THETACThetaRepositoryExposureCompensationEnum.p03,
    @"P_0_7": THETACThetaRepositoryExposureCompensationEnum.p07,
    @"P_1_0": THETACThetaRepositoryExposureCompensationEnum.p10,
    @"P_1_3": THETACThetaRepositoryExposureCompensationEnum.p13,
    @"P_1_7": THETACThetaRepositoryExposureCompensationEnum.p17,
    @"P_2_0": THETACThetaRepositoryExposureCompensationEnum.p20
  },
  .fromTheta = @{
    THETACThetaRepositoryExposureCompensationEnum.m20: @"M_2_0",
    THETACThetaRepositoryExposureCompensationEnum.m17: @"M_1_7",
    THETACThetaRepositoryExposureCompensationEnum.m13: @"M_1_3",
    THETACThetaRepositoryExposureCompensationEnum.m10: @"M_1_0",
    THETACThetaRepositoryExposureCompensationEnum.m07: @"M_0_7",
    THETACThetaRepositoryExposureCompensationEnum.m03: @"M_0_3",
    THETACThetaRepositoryExposureCompensationEnum.zero: @"ZERO",
    THETACThetaRepositoryExposureCompensationEnum.p03: @"P_0_3",
    THETACThetaRepositoryExposureCompensationEnum.p07: @"P_0_7",
    THETACThetaRepositoryExposureCompensationEnum.p10: @"P_1_0",
    THETACThetaRepositoryExposureCompensationEnum.p13: @"P_1_3",
    THETACThetaRepositoryExposureCompensationEnum.p17: @"P_1_7",
    THETACThetaRepositoryExposureCompensationEnum.p20: @"P_2_0",
  },
  .setToTheta = ^(NSDictionary* rct, THETACThetaRepositoryOptions *opt) {
